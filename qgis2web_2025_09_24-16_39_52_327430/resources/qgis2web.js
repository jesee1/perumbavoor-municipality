...
map.getView().fit([8505149.086423, 1128512.023010, 8520912.904495, 1136041.928434], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PERUMBAVOOR MUNICIPALITY WARD MAP</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (98 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This website is created using opensource software. This includes Perumbavoor Municipality ward map';
            }
